...
df_main = pd.read_csv("/home/shahil/Desktop/Python/ReccommenderSystem/training_ratings_for_kaggle_comp.csv")
print(df_main.head(3))

#converting .dat into a dataframe
column_names = ['movie','movie_name','genre']
df_movie = pd.read_csv("/home/shahil/Desktop/Python/ReccommenderSystem/movies.dat",sep="::",names=column_names)

#merging into main df
df_main = df_main.merge(df_movie,on='movie')
